...
METRIC_REGISTRY: dict[str, tuple[str, str]] = {
    ...
    "f1hoppr_ctb_rrg_lv001_cls_lv001_p0": ("radeval.metrics.f1hoppr_ctb_rrg_lv001_cls_lv001_p0.adapter", "F1HopprCtbRrgLv001ClsLv001P0Metric"),
    "f1hoppr_ctb_rrg_lv001_cls_lv001_core10k": ("radeval.metrics.f1hoppr_ctb_rrg_lv001_cls_lv001_core10k.adapter", "F1HopprCtbRrgLv001ClsLv001Core10kMetric"),
    "f1hoppr_ctb_rrg_lv001_cls_lv001_all": ("radeval.metrics.f1hoppr_ctb_rrg_lv001_cls_lv001_all.adapter", "F1HopprCtbRrgLv001ClsLv001AllMetric"),
    "f1hopprchexbert_msk": ("radeval.metrics.f1hopprchexbert_msk.adapter", "F1HopprCheXbertMSKMetric"),
    "f1hopprchexbert_mammo": ("radeval.metrics.f1hopprchexbert_mammo.adapter", "F1HopprCheXbertMammoMetric"),
